...
const AllBooks = () => {
   ...
   const { data, isLoading, refetch } = useAllBooks(categoryName, availability, email, debouncedQuery);
                  ...
                  <div className="pt-12">
                     {
                        categories?.map(category => (
                           <button onClick={() => handleCategory(category.categoryName)} key={category._id} className="flex items-center gap-5">
                  ...
                  <div className="h-36">
                     ...
                     <div className="md:flex items-center justify-between mt-8 dark:text-white">
                        <div className="flex items-center">
                           ...
                           <select onChange={(e) => handleSort(e)} className="w-72 rounded-md p-2 text-base bg-gray-300  dark:bg-gray-700 dark:text-white">
